...
local scroll_keys = {
  ["<A-k>"] = function() neoscroll.ctrl_u({ duration = 250; easing = "sine" }) end,
  ["<A-j>"] = function() neoscroll.ctrl_d({ duration = 250; easing = "sine" }) end,
  ["<A-h>"] = function() neoscroll.ctrl_b({ duration = 450; easing = 'circular' }) end,
  ["<A-l>"] = function() neoscroll.ctrl_f({ duration = 450; easing = 'circular' }) end,
